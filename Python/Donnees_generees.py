...
data_dir = "E:/Master 2/Simulateddata/data/fake/knowed/"
...
for i in range(1,len(test)+1):
    for images, labels in test.take(i):  # only take first element of dataset
        if i == 1:
...
test_images_fin = test_images_fin.reshape(40,64,64,3)
...
for i in range(len(test_images_fin)):
    ...
    plt.axis("off")
    dirname = "E:/Master 2/Simulateddata/data/fake/test_verif"
    name = 'Image' + str(i+1)
