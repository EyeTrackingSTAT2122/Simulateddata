  ...
  if (res$Classe[liste1[i]] == "Equilibre"){
    if (res$item_id[liste1[i]]==Brazil){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        annotation_custom(imgR,xmin = -120,xmax = 1100, ymin = -90, ymax = 720) +
        theme_void()+
    ...
    if (res$item_id[liste1[i]]==Brazil){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"France.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
    else if (res$item_id[liste1[i]] == Greece){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"Greece.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
    else if (res$item_id[liste1[i]] == Italy){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"Italy.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
    else if (res$item_id[liste1[i]] == South_Korea){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"South_Korea.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
    else if (res$item_id[liste1[i]] == Spain){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"Spain.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
    else if (res$item_id[liste1[i]] == Ukraine){
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"Ukraine.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
    else {
      ...
      heatmap <- ggplot(data, aes(x=x, y=y))+
        ...
        theme(legend.title = element_blank()) +
        theme(legend.position='none')
      png(file = paste0("study/Test/Pas_equilibre/",res$tester_id[liste1[i]],"USA.png"),width = 780, height = 480)
      plot(heatmap)
      dev.off()
    }
  }
...
heatmap <- ggplot(data, aes(x=x, y=y))+
  ...
  theme(legend.title = element_blank()) +
  theme(legend.position='none')
png(file = paste0("study/Test/test.png"),)
plot(heatmap)
dev.off()
